/** ComputeFailOverCallableExample.java -
* @version      $Name$
 ...
 */
public class ComputeFailOverCallableExample {
	...
	public static void main(String[] args) {
		...
		try (Ignite ignite = Ignition.start(ComputeFailOverNodeStartup.configuration())) {
			...
			// Number of letters.
            int charCnt = ignite.compute().call(new CheckPointJob("Stage1 Stage2"));
	...
	private static final class CheckPointJob implements IgniteCallable<Integer> {
		...
		public CheckPointJob(String phrase) {
			this.phrase = phrase;
		}
